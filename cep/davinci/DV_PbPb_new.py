...
#    """
#)
fltrs = LoKi_Filters( HLT1_Code = "(HLT_PASS('Hlt1BBMicroBiasSoftCEPDecision')) | (HLT_PASS('Hlt1BBMicroBiasLowMultVeloDecision'))")
...
db = CondDB( LatestGlobalTagByDataType = '2018' )
...
dcDiK = { }
dcDiK['K+'] = "(ISLONG)" # & (TRGHOSTPROB < 0.3)"
combcutsDiK = "(in_range( 900, AM, 1100 ))"
parentcutsDiK = "ALL"
...
#                , "TupleToolPropertime"
    ...
    tool.TriggerList = [ "L0HadronDecision",
#                         "L0HadronHighMultDecision",
                         "L0MuonDecision",
                         "L0SPDDecision",
#                         "L0CALODecision",
                         "L0HadronLowMultDecision",
                         "L0MuonLowMultDecision",
                         "L0ElectronLowMultDecision",
                         "L0PhotonLowMultDecision",
                         "L0DiEMLowMultDecision",
                         "L0SPDLowMultDecision",
                         "L0SoftCEPDecision",
#                         "Hlt1BBNoBiasDecision",
                         "Hlt1BBMicroBiasLowMultVeloDecision",
                         "Hlt1BBMicroBiasSoftCEPDecision",
                         "Hlt1BBHasTrackDecision",
#                         "Hlt1BBHighMultDecision",
#                         "Hlt1L0PhotonLowMultDecision",
#                         "Hlt1SingleMuonHighPTDecision",
#                         "Hlt1DiMuonHighMassDecision",
#                         "Hlt1BBVeryHighMultDecision",
                         "Hlt2BBPassThroughDecision",
                         "Hlt2MBMicroBiasLowMultVeloDecision",
                         "Hlt2BBLongTrackDecision",
                         "Hlt2SingleTrackDecision",
                         "Hlt2MBMicroBiasVeloDecision",
#                         "Hlt2BBHighMultDecision",
                         ]
