...
//  gROOT->ProcessLine(".L DPKinematics/LauKinematics.cc");
  ...
  TColor::CreateGradientColorTable(NRGBs, stops, red, green, blue, NCont);
  gStyle->SetNumberContours(NCont);
  sel_Eff("Sim08aMCEff","D2KK/Bd2DKpi_truth","Bd2KpiD0/tupleMCTruth","Sim08aMC","D2KK/Bd2D0Kpi/D2KK_Bd2D0Kpi_selBd_Dsignal_vetoes_noDPV_NND2KK_addIMs_addMisIDIMs","DecayTree", -0.80,  1.00,"all");
  sel_Eff("Sim08aMCEff","D2KK/Bd2DKpi_truth","Bd2KpiD0/tupleMCTruth","Sim08aMC","D2KK/Bd2D0Kpi/D2KK_Bd2D0Kpi_selBd_Dsignal_vetoes_noDPV_NND2KK_addIMs_addMisIDIMs","DecayTree", -0.80, -0.08,"a");
  sel_Eff("Sim08aMCEff","D2KK/Bd2DKpi_truth","Bd2KpiD0/tupleMCTruth","Sim08aMC","D2KK/Bd2D0Kpi/D2KK_Bd2D0Kpi_selBd_Dsignal_vetoes_noDPV_NND2KK_addIMs_addMisIDIMs","DecayTree", -0.08,  0.43,"b");
  sel_Eff("Sim08aMCEff","D2KK/Bd2DKpi_truth","Bd2KpiD0/tupleMCTruth","Sim08aMC","D2KK/Bd2D0Kpi/D2KK_Bd2D0Kpi_selBd_Dsignal_vetoes_noDPV_NND2KK_addIMs_addMisIDIMs","DecayTree",  0.43,  0.59,"c");
  sel_Eff("Sim08aMCEff","D2KK/Bd2DKpi_truth","Bd2KpiD0/tupleMCTruth","Sim08aMC","D2KK/Bd2D0Kpi/D2KK_Bd2D0Kpi_selBd_Dsignal_vetoes_noDPV_NND2KK_addIMs_addMisIDIMs","DecayTree",  0.59,  0.67,"d");
  sel_Eff("Sim08aMCEff","D2KK/Bd2DKpi_truth","Bd2KpiD0/tupleMCTruth","Sim08aMC","D2KK/Bd2D0Kpi/D2KK_Bd2D0Kpi_selBd_Dsignal_vetoes_noDPV_NND2KK_addIMs_addMisIDIMs","DecayTree",  0.67,  1.00,"e");
}
