{
	...
	TFile* f = TFile::Open("hists/l0hNew_sq5_all.root");
	...
	eff->GetZaxis()->SetRangeUser(0.85,1.05);
	eff->Draw("colztext30");
	canvas->SaveAs("../latex/figs/l0hadCorr_eff.pdf");
	eff->Draw("colz");
	canvas->SaveAs("../latex/figs/l0hadCorr_eff_nolabel.pdf");
	canvas->SaveAs("../ANAPlots/l0h_eff.pdf");
	...
	canvas->SaveAs("../latex/figs/l0hadCorr_errp.pdf");
	...
	canvas->SaveAs("../latex/figs/l0hadCorr_errm.pdf");
	...
	canvas->SaveAs("../latex/figs/l0hadCorr_errpStats.pdf");
	...
	canvas->SaveAs("../latex/figs/l0hadCorr_errmStats.pdf");
	...
	canvas->SaveAs("../latex/figs/l0hadCorr_errTable.pdf");
	...
	errppc->GetZaxis()->SetRangeUser(0.010,0.03);
	canvas->SetRightMargin(0.17);
	errppc->Draw("colztext30");
	canvas->SaveAs("../latex/figs/l0hadCorr_errp_frac.pdf");
	errppc->Draw("colz");
	canvas->SaveAs("../latex/figs/l0hadCorr_errp_frac_nolabel.pdf");
	canvas->SaveAs("../ANAPlots/l0h_errp.pdf");
	...
	errmpc->GetZaxis()->SetRangeUser(0.010,0.03);
	canvas->SetRightMargin(0.17);
	errmpc->Draw("colztext30");
	canvas->SaveAs("../latex/figs/l0hadCorr_errm_frac.pdf");
	errmpc->Draw("colz");
	canvas->SaveAs("../latex/figs/l0hadCorr_errm_frac_nolabel.pdf");
	canvas->SaveAs("../ANAPlots/l0h_errm.pdf");
	...
	errstatppc->GetZaxis()->SetRangeUser(0.010,0.03);
	canvas->SetRightMargin(0.17);
	errstatppc->Draw("colztext30");
	canvas->SaveAs("../latex/figs/l0hadCorr_errpStat_frac.pdf");
	errstatppc->Draw("colz");
	canvas->SaveAs("../latex/figs/l0hadCorr_errpStat_frac_nolabel.pdf");
	canvas->SaveAs("../ANAPlots/l0h_errp_stat.pdf");
	...
	errstatmpc->GetZaxis()->SetRangeUser(0.010,0.03);
	canvas->SetRightMargin(0.17);
	errstatmpc->Draw("colztext30");
	canvas->SaveAs("../latex/figs/l0hadCorr_errmStat_frac.pdf");
	errstatmpc->Draw("colz");
	canvas->SaveAs("../latex/figs/l0hadCorr_errmStat_frac_nolabel.pdf");
	canvas->SaveAs("../ANAPlots/l0h_errm_stat.pdf");
	...
	canvas->SaveAs("../latex/figs/l0hadCorr_errTable_frac.pdf");
	errtabpc->Draw("colz");
	canvas->SaveAs("../latex/figs/l0hadCorr_errTable_frac_nolabel.pdf");
	canvas->SaveAs("../ANAPlots/l0h_err_table.pdf");
