void fit(TH1D* h, Double_t& sh, Double_t& sl, TString plotName="") {
   ...
   RooRealVar sigmaLo("sigmaLo","",0.005,0.0005,0.05,"");
...
void fitBootstrappedHists() {
   ...
   TFile* f = TFile::Open("trk_sq_Bd_bootstrapped.root");
   ...
   TFile* outfile = TFile::Open("hists/trk_sq10_Bd_errStat_asym.root","recreate");
