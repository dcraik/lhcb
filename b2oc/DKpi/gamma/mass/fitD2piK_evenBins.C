...
//	gStyle.SetOptStat(1111);
	...
	TFile * file = TFile::Open("/data/lhcb/phrkbf/B2DKpi/Job2012_B2DKpi_D2Kpi_Scaled/B2D0Kpi_D02piK_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs.root");
	...
	//// B0 -> D(*) pi pi
	TFile * fileK2 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2Kpi/hists/D2piK_Bd2D0pipi_smooth1_bins50_SDPweight_hist.root");
	...
	//// Lambda b -> D p pi
	TFile * fileK3 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2Kpi/hists/D2piK_Lb2D0ppi_smooth3_bins50_SDPweight_hist.root");
	...
	////Bd -> D K K
	TFile * fileK4 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2Kpi/hists/D2piK_Bd2D0KK_smooth1_bins50_SDPweight_hist.root");
	...
	//Bs -> D K K
	TFile * fileK5 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2Kpi/hists/D2piK_Bs2D0KK_smooth1_bins50_SDPweight_hist.root");
	...
	TFile * fileK6 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2Kpi/hists/D2Kpi_Bs2Dst0Kpi_smooth1_bins50_SDPweight_hist.root");
	TH2D  * histK6  = dynamic_cast<TH2D*>(fileK6->Get("Bs2Dst0Kpi"));
	TH1D  * histK6a = histK6->ProjectionX("Bs2D0stkpi_A",11,100);
	histK6a->Smooth(1);
	RooDataHist * dataK6 = new RooDataHist("dataK6", "", RooArgSet(B_D0_B_CM_M), histK6a);
	RooHistPdf bs2dstkpi("bs2dstkpi","", RooArgSet(B_D0_B_CM_M), *dataK6, 2);

	// B Gaussian 
	// start, range to from. plus names and titles.
	RooRealVar sigmean("M_{B}","B mass",5281.0,5270.0,5290.0,"MeV/c^{2}");
	RooRealVar sigsigma("#sigma_{B}","B sigma",15.0,7.0,25.0,"MeV/c^{2}");
	RooRealVar ratio("ratio","Ratio of widths",1.47,1.0,3.0);
	RooProduct sigsigma2("#sigma_{B}2","B sigma2",RooArgSet(sigsigma,ratio));
	RooRealVar frac("frac","fraction of events in each gaussian",0.49,0.0,1.0);
	...
	RooRealVar p0("p0","",-0.0006,-0.1,0.1);
...
//	RooRealVar combfrac("combfrac","",0.9,0.0,1.0);
//
//	RooAddPdf comb_bkg("comb_bkg","",RooArgList(comb_bkg1,bu2dstk),RooArgList(combfrac));

	// Number of signal & background events
	RooRealVar nbkg("nbkg","",11000,-1000,20000);
	RooRealVar nsig("nsig","",600,-1000,8000);
	RooRealVar nsig2("nsig2","",11000,-1000,20000);
	RooRealVar nbkg2("nbkg2","",2700,-1000,8000);
	RooRealVar nbkg3("nbkg3","",17000,-1000,20000);
	RooRealVar nbkg4("nbkg4","",11000*0.064,-1000,8000);
	RooRealVar nbkg5("nbkg5","",11000*0.200,-1000,8000);
	RooRealVar nbkg6("nbkg6","",11000*0.030,-1000,3000);
	RooRealVar nbkg7("nbkg7","",11000*0.012,-1000,3000);

	//// Constrain Dpipi background
	RooFormulaVar bd2dpipiratio("bd2dpipiratio","@0/@1",RooArgList(nbkg4,nsig2));
	RooGaussian constrain_bd2dpipiratio("cbd2dpipi","cbd2dpipi",bd2dpipiratio,RooFit::RooConst(0.064),RooFit::RooConst(0.012));

	//// Constrain Dppi background
	RooFormulaVar lb2dppiratio("lb2dppiratio","@0/@1",RooArgList(nbkg5,nsig2));
	RooGaussian constrain_lb2dppiratio("clb2dppi","clb2dppi",lb2dppiratio,RooFit::RooConst(0.200),RooFit::RooConst(0.050));

	//// Constrain DKK background
	RooFormulaVar bd2dkkratio("bd2dkkratio","@0/@1",RooArgList(nbkg6,nsig2));
	RooGaussian constrain_bd2dkkratio("cbd2dkk","cbd2dkk",bd2dkkratio,RooFit::RooConst(0.030),RooFit::RooConst(0.009));
	
	//// Constrain BsDKK background
	RooFormulaVar bs2dkkratio("bs2dkkratio","@0/@1",RooArgList(nbkg7,nsig2));
	RooGaussian constrain_bs2dkkratio("cbs2dkk","cbs2dkk",bs2dkkratio,RooFit::RooConst(0.012),RooFit::RooConst(0.005));


	//RooRealVar nbkg4("nbkg4","",11000*0.051,-1000,8000);
	//RooRealVar nbkg5("nbkg5","",11000*0.240,-1000,8000);
	//RooRealVar nbkg6("nbkg6","",11000*0.020,-1000,3000);
	//RooRealVar nbkg7("nbkg7","",11000*0.006,-1000,3000);

	////// Constrain Dpipi background
	//RooFormulaVar bd2dpipiratio("bd2dpipiratio","@0/@1",RooArgList(nbkg4,nsig2));
	//RooGaussian constrain_bd2dpipiratio("cbd2dpipi","cbd2dpipi",bd2dpipiratio,RooFit::RooConst(0.051),RooFit::RooConst(0.009));

	////// Constrain Dppi background
	//RooFormulaVar lb2dppiratio("lb2dppiratio","@0/@1",RooArgList(nbkg5,nsig2));
	//RooGaussian constrain_lb2dppiratio("clb2dppi","clb2dppi",lb2dppiratio,RooFit::RooConst(0.24),RooFit::RooConst(0.07));

	////// Constrain DKK background
	//RooFormulaVar bd2dkkratio("bd2dkkratio","@0/@1",RooArgList(nbkg6,nsig2));
	//RooGaussian constrain_bd2dkkratio("cbd2dkk","cbd2dkk",bd2dkkratio,RooFit::RooConst(0.020),RooFit::RooConst(0.006));
	//
	////// Constrain BsDKK background
	//RooFormulaVar bs2dkkratio("bs2dkkratio","@0/@1",RooArgList(nbkg7,nsig2));
	//RooGaussian constrain_bs2dkkratio("cbs2dkk","cbs2dkk",bs2dkkratio,RooFit::RooConst(0.006),RooFit::RooConst(0.003));


	RooRealVar afrac("afrac","",0.12,0.0,1.0);
	RooRealVar bfrac("bfrac","",0.15,0.0,1.0);
	RooRealVar cfrac("cfrac","",0.16,0.0,1.0);
	RooRealVar dfrac("dfrac","",0.2,0.0,1.0);
	RooFormulaVar efrac("efrac","","1-afrac-bfrac-cfrac-dfrac",RooArgList(afrac,bfrac,cfrac,dfrac));

	RooRealVar aprfrac("aprfrac","",0.13,0.0,1.0);
	RooRealVar bprfrac("bprfrac","",0.16,0.0,1.0);
	RooRealVar cprfrac("cprfrac","",0.19,0.0,1.0);
	RooRealVar dprfrac("dprfrac","",0.21,0.0,1.0);
	RooFormulaVar eprfrac("eprfrac","","1-aprfrac-bprfrac-cprfrac-dprfrac",RooArgList(aprfrac,bprfrac,cprfrac,dprfrac));

	RooRealVar abkgfrac("abkgfrac","",0.77,0.0,1.0);
	RooRealVar bbkgfrac("bbkgfrac","",0.16,0.0,1.0);
	RooRealVar cbkgfrac("cbkgfrac","",0.05,0.0,1.0);
	RooRealVar dbkgfrac("dbkgfrac","",0.02,0.0,1.0);
	...
	RooArgList pdfs(BSig,BsSig,comb_bkg,bd2dstkpi,bs2dstkpi,bd2dpipi,lb2dppi,bd2dkk,bs2dkk);
	...
	RooProdPdf fullpdf("fullpdf","",RooArgList(Simpdf,constrain_ratio,constrain_frac,constrain_bd2dpipiratio,constrain_lb2dppiratio,constrain_bd2dkkratio,constrain_bs2dkkratio));
	...
	Simpdf->plotOn(aPlot, RooFit::Slice(cat,"cata"),RooFit::ProjWData(cat,combo), RooFit::Components("BSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(aPlot, RooFit::Slice(cat,"cata"),RooFit::ProjWData(cat,combo), RooFit::Components("BsSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(aPlot, RooFit::Slice(cat,"cata"),RooFit::ProjWData(cat,combo), RooFit::Components("comb_bkg"),RooFit::LineStyle(kDashed),RooFit::LineColor(kMagenta));
	Simpdf->plotOn(aPlot, RooFit::Slice(cat,"cata"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dstkpi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kRed));
	...
	Simpdf->plotOn(aPlot, RooFit::Slice(cat,"cata"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dpipi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kGreen+2));
	Simpdf->plotOn(aPlot, RooFit::Slice(cat,"cata"),RooFit::ProjWData(cat,combo), RooFit::Components("lb2dppi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kBlack));
	Simpdf->plotOn(aPlot, RooFit::Slice(cat,"cata"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dkk"),RooFit::LineStyle(kDashed),RooFit::LineColor(kOrange-3));
	...
	Simpdf->plotOn(bPlot, RooFit::Slice(cat,"catb"),RooFit::ProjWData(cat,combo), RooFit::Components("BSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(bPlot, RooFit::Slice(cat,"catb"),RooFit::ProjWData(cat,combo), RooFit::Components("BsSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(bPlot, RooFit::Slice(cat,"catb"),RooFit::ProjWData(cat,combo), RooFit::Components("comb_bkg"),RooFit::LineStyle(kDashed),RooFit::LineColor(kMagenta));
	Simpdf->plotOn(bPlot, RooFit::Slice(cat,"catb"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dstkpi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kRed));
	...
	Simpdf->plotOn(bPlot, RooFit::Slice(cat,"catb"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dpipi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kGreen+2));
	Simpdf->plotOn(bPlot, RooFit::Slice(cat,"catb"),RooFit::ProjWData(cat,combo), RooFit::Components("lb2dppi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kBlack));
	Simpdf->plotOn(bPlot, RooFit::Slice(cat,"catb"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dkk"),RooFit::LineStyle(kDashed),RooFit::LineColor(kOrange-3));
	...
	Simpdf->plotOn(cPlot, RooFit::Slice(cat,"catc"),RooFit::ProjWData(cat,combo), RooFit::Components("BSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(cPlot, RooFit::Slice(cat,"catc"),RooFit::ProjWData(cat,combo), RooFit::Components("BsSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(cPlot, RooFit::Slice(cat,"catc"),RooFit::ProjWData(cat,combo), RooFit::Components("comb_bkg"),RooFit::LineStyle(kDashed),RooFit::LineColor(kMagenta));
	Simpdf->plotOn(cPlot, RooFit::Slice(cat,"catc"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dstkpi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kRed));
	...
	Simpdf->plotOn(cPlot, RooFit::Slice(cat,"catc"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dpipi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kGreen+2));
	Simpdf->plotOn(cPlot, RooFit::Slice(cat,"catc"),RooFit::ProjWData(cat,combo), RooFit::Components("lb2dppi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kBlack));
	Simpdf->plotOn(cPlot, RooFit::Slice(cat,"catc"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dkk"),RooFit::LineStyle(kDashed),RooFit::LineColor(kOrange-3));
	...
	Simpdf->plotOn(dPlot, RooFit::Slice(cat,"catd"),RooFit::ProjWData(cat,combo), RooFit::Components("BSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(dPlot, RooFit::Slice(cat,"catd"),RooFit::ProjWData(cat,combo), RooFit::Components("BsSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(dPlot, RooFit::Slice(cat,"catd"),RooFit::ProjWData(cat,combo), RooFit::Components("comb_bkg"),RooFit::LineStyle(kDashed),RooFit::LineColor(kMagenta));
	Simpdf->plotOn(dPlot, RooFit::Slice(cat,"catd"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dstkpi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kRed));
	...
	Simpdf->plotOn(dPlot, RooFit::Slice(cat,"catd"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dpipi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kGreen+2));
	Simpdf->plotOn(dPlot, RooFit::Slice(cat,"catd"),RooFit::ProjWData(cat,combo), RooFit::Components("lb2dppi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kBlack));
	Simpdf->plotOn(dPlot, RooFit::Slice(cat,"catd"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dkk"),RooFit::LineStyle(kDashed),RooFit::LineColor(kOrange-3));
	...
	Simpdf->plotOn(ePlot, RooFit::Slice(cat,"cate"),RooFit::ProjWData(cat,combo), RooFit::Components("BSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(ePlot, RooFit::Slice(cat,"cate"),RooFit::ProjWData(cat,combo), RooFit::Components("BsSig"),RooFit::LineStyle(kDashed));
	Simpdf->plotOn(ePlot, RooFit::Slice(cat,"cate"),RooFit::ProjWData(cat,combo), RooFit::Components("comb_bkg"),RooFit::LineStyle(kDashed),RooFit::LineColor(kMagenta));
	Simpdf->plotOn(ePlot, RooFit::Slice(cat,"cate"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dstkpi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kRed));
	...
	Simpdf->plotOn(ePlot, RooFit::Slice(cat,"cate"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dpipi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kGreen+2));
	Simpdf->plotOn(ePlot, RooFit::Slice(cat,"cate"),RooFit::ProjWData(cat,combo), RooFit::Components("lb2dppi"),RooFit::LineStyle(kDashed),RooFit::LineColor(kBlack));
	Simpdf->plotOn(ePlot, RooFit::Slice(cat,"cate"),RooFit::ProjWData(cat,combo), RooFit::Components("bd2dkk"),RooFit::LineStyle(kDashed),RooFit::LineColor(kOrange-3));
	...
	can->SaveAs("D2piKfit_fit.C");
	can2->SaveAs("D2piKfit_pull.C");

	uppLineA = new TLine( sigmeanBs.getVal() + 2.5*sigsigma.getVal(), aPlot->GetMinimum(), 
	        	      sigmeanBs.getVal() + 2.5*sigsigma.getVal(), aPlot->GetMaximum() );
	lowLineA = new TLine( sigmeanBs.getVal() - 2.5*sigsigma.getVal(), aPlot->GetMinimum(), 
			      sigmeanBs.getVal() - 2.5*sigsigma.getVal(), aPlot->GetMaximum() );

	uppLineB = new TLine( sigmeanBs.getVal() + 2.5*sigsigma.getVal(), bPlot->GetMinimum(), 
	        	      sigmeanBs.getVal() + 2.5*sigsigma.getVal(), bPlot->GetMaximum() );
	lowLineB = new TLine( sigmeanBs.getVal() - 2.5*sigsigma.getVal(), bPlot->GetMinimum(), 
			      sigmeanBs.getVal() - 2.5*sigsigma.getVal(), bPlot->GetMaximum() );

	uppLineC = new TLine( sigmeanBs.getVal() + 2.5*sigsigma.getVal(), cPlot->GetMinimum(), 
	        	      sigmeanBs.getVal() + 2.5*sigsigma.getVal(), cPlot->GetMaximum() );
	lowLineC = new TLine( sigmeanBs.getVal() - 2.5*sigsigma.getVal(), cPlot->GetMinimum(), 
			      sigmeanBs.getVal() - 2.5*sigsigma.getVal(), cPlot->GetMaximum() );

	uppLineD = new TLine( sigmeanBs.getVal() + 2.5*sigsigma.getVal(), dPlot->GetMinimum(), 
	        	      sigmeanBs.getVal() + 2.5*sigsigma.getVal(), dPlot->GetMaximum() );
	lowLineD = new TLine( sigmeanBs.getVal() - 2.5*sigsigma.getVal(), dPlot->GetMinimum(), 
			      sigmeanBs.getVal() - 2.5*sigsigma.getVal(), dPlot->GetMaximum() );

	uppLineE = new TLine( sigmeanBs.getVal() + 2.5*sigsigma.getVal(), ePlot->GetMinimum(), 
	        	      sigmeanBs.getVal() + 2.5*sigsigma.getVal(), ePlot->GetMaximum() );
	lowLineE = new TLine( sigmeanBs.getVal() - 2.5*sigsigma.getVal(), ePlot->GetMinimum(), 
			      sigmeanBs.getVal() - 2.5*sigsigma.getVal(), ePlot->GetMaximum() );
	...
	TCanvas * temp = new TCanvas("temp","");
	aPlot->Draw(); temp->SaveAs("figs/D2piKfit_1.pdf"); temp->SaveAs("figs/D2piKfit_1.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2piKfit_1_log.pdf"); temp->SetLogy(0);
	bPlot->Draw(); temp->SaveAs("figs/D2piKfit_2.pdf"); temp->SaveAs("figs/D2piKfit_2.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2piKfit_2_log.pdf"); temp->SetLogy(0);
	cPlot->Draw(); temp->SaveAs("figs/D2piKfit_3.pdf"); temp->SaveAs("figs/D2piKfit_3.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2piKfit_3_log.pdf"); temp->SetLogy(0);
	dPlot->Draw(); temp->SaveAs("figs/D2piKfit_4.pdf"); temp->SaveAs("figs/D2piKfit_4.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2piKfit_4_log.pdf"); temp->SetLogy(0);
	ePlot->Draw(); temp->SaveAs("figs/D2piKfit_5.pdf"); temp->SaveAs("figs/D2piKfit_5.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2piKfit_5_log.pdf"); temp->SetLogy(0);
	aPlot3->Draw(); temp->SaveAs("figs/D2piKfit_1_pull.pdf"); temp->SaveAs("figs/D2piKfit_1_pull.C");
	bPlot3->Draw(); temp->SaveAs("figs/D2piKfit_2_pull.pdf"); temp->SaveAs("figs/D2piKfit_2_pull.C");
	cPlot3->Draw(); temp->SaveAs("figs/D2piKfit_3_pull.pdf"); temp->SaveAs("figs/D2piKfit_3_pull.C");
	dPlot3->Draw(); temp->SaveAs("figs/D2piKfit_4_pull.pdf"); temp->SaveAs("figs/D2piKfit_4_pull.C");
	ePlot3->Draw(); temp->SaveAs("figs/D2piKfit_5_pull.pdf"); temp->SaveAs("figs/D2piKfit_5_pull.C");
	aPlot4->Draw(); temp->SaveAs("figs/D2piKfit_1_window.pdf"); temp->SaveAs("figs/D2piKfit_1_window.C");
	bPlot4->Draw(); temp->SaveAs("figs/D2piKfit_2_window.pdf"); temp->SaveAs("figs/D2piKfit_2_window.C");
	cPlot4->Draw(); temp->SaveAs("figs/D2piKfit_3_window.pdf"); temp->SaveAs("figs/D2piKfit_3_window.C");
	dPlot4->Draw(); temp->SaveAs("figs/D2piKfit_4_window.pdf"); temp->SaveAs("figs/D2piKfit_4_window.C");
	ePlot4->Draw(); temp->SaveAs("figs/D2piKfit_5_window.pdf"); temp->SaveAs("figs/D2piKfit_5_window.C");
	...
	printf("$B^0$ window purity   & %5.1f\\,\\%% & %5.1f\\,\\%% & %5.1f\\,\\%% & %5.1f\\,\\%% & %5.1f\\,\\%%\\\\\n",
		100*afrac->getValV()*nBd1/(afrac->getValV()*(nBd1+nBs1+nBd2Dpipi1+nLb2Dppi1+nBd2DKK1+nBs2DKK1)+abkgfrac->getValV()*nComb1+aprfrac->getValV()*(nBd2DstKpi1+nBs2DstKpi1)),
		100*bfrac->getValV()*nBd1/(bfrac->getValV()*(nBd1+nBs1+nBd2Dpipi1+nLb2Dppi1+nBd2DKK1+nBs2DKK1)+bbkgfrac->getValV()*nComb1+bprfrac->getValV()*(nBd2DstKpi1+nBs2DstKpi1)),
		100*cfrac->getValV()*nBd1/(cfrac->getValV()*(nBd1+nBs1+nBd2Dpipi1+nLb2Dppi1+nBd2DKK1+nBs2DKK1)+cbkgfrac->getValV()*nComb1+cprfrac->getValV()*(nBd2DstKpi1+nBs2DstKpi1)),
		100*dfrac->getValV()*nBd1/(dfrac->getValV()*(nBd1+nBs1+nBd2Dpipi1+nLb2Dppi1+nBd2DKK1+nBs2DKK1)+dbkgfrac->getValV()*nComb1+dprfrac->getValV()*(nBd2DstKpi1+nBs2DstKpi1)),
		100*efrac->getValV()*nBd1/(efrac->getValV()*(nBd1+nBs1+nBd2Dpipi1+nLb2Dppi1+nBd2DKK1+nBs2DKK1)+ebkgfrac->getValV()*nComb1+eprfrac->getValV()*(nBd2DstKpi1+nBs2DstKpi1)));
	...
	printf("$B_s^0$ window purity & %5.1f\\,\\%% & %5.1f\\,\\%% & %5.1f\\,\\%% & %5.1f\\,\\%% & %5.1f\\,\\%%\\\\\n",
		100*afrac->getValV()*nBs2/(afrac->getValV()*(nBd2+nBs2+nBd2Dpipi2+nLb2Dppi2+nBd2DKK2+nBs2DKK2)+abkgfrac->getValV()*nComb2+aprfrac->getValV()*(nBd2DstKpi2+nBs2DstKpi2)),
		100*bfrac->getValV()*nBs2/(bfrac->getValV()*(nBd2+nBs2+nBd2Dpipi2+nLb2Dppi2+nBd2DKK2+nBs2DKK2)+bbkgfrac->getValV()*nComb2+bprfrac->getValV()*(nBd2DstKpi2+nBs2DstKpi2)),
		100*cfrac->getValV()*nBs2/(cfrac->getValV()*(nBd2+nBs2+nBd2Dpipi2+nLb2Dppi2+nBd2DKK2+nBs2DKK2)+cbkgfrac->getValV()*nComb2+cprfrac->getValV()*(nBd2DstKpi2+nBs2DstKpi2)),
		100*dfrac->getValV()*nBs2/(dfrac->getValV()*(nBd2+nBs2+nBd2Dpipi2+nLb2Dppi2+nBd2DKK2+nBs2DKK2)+dbkgfrac->getValV()*nComb2+dprfrac->getValV()*(nBd2DstKpi2+nBs2DstKpi2)),
		100*efrac->getValV()*nBs2/(efrac->getValV()*(nBd2+nBs2+nBd2Dpipi2+nLb2Dppi2+nBd2DKK2+nBs2DKK2)+ebkgfrac->getValV()*nComb2+eprfrac->getValV()*(nBd2DstKpi2+nBs2DstKpi2)));
	cout << endl;
