...
//	gStyle.SetOptStat(1111);
	...
	TFile * file = TFile::Open("/data/lhcb/phrkbf/B2DKpi/Job2012_B2DKpi_D2pipi_Scaled/B2D0Kpi_D02pipi_selBd_Dsignal_Dst25_vetoes_PID3_NND2pipi_addIMs.root");
	...
	RooDataSet * adata = data1->reduce("NN>-0.8 && NN<=-0.25");
	RooDataSet * bdata = data1->reduce("NN>-0.25 && NN<=0.23");
	RooDataSet * cdata = data1->reduce("NN>0.23 && NN<=0.57");
	RooDataSet * ddata = data1->reduce("NN>0.57 && NN<=0.74");
	RooDataSet * edata = data1->reduce("NN>0.74 && NN<=1.0");
	...
	TFile * fileK1 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2pipi/hists/D2pipi_Bd2Dst0Kpi_smooth1_bins50_SDPweight_hist.root");
	...
	//// B0 -> D(*) pi pi
	TFile * fileK2 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2pipi/hists/D2pipi_Bd2D0pipi_smooth1_bins50_SDPweight_hist.root");
	...
	//// Lambda b -> D p pi
	TFile * fileK3 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2pipi/hists/D2pipi_Lb2D0ppi_smooth3_bins50_SDPweight_hist.root");
	...
	//// Lambda b -> D p K
	TFile * fileK4 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2pipi/hists/D2pipi_Lb2D0pK_smooth3_bins50_SDPweight_hist.root");
	...
	////Bd -> D K K
	TFile * fileK5 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2pipi/hists/D2pipi_Bd2D0KK_smooth1_bins50_SDPweight_hist.root");
...
//	TFile * fileK7 = TFile::Open("/data/lhcb/phrkbf/B2DKpi/JobSim08aMC/D2pipi/hists/D2pipi_Bs2Dst0Kpi_smooth1_bins50_SDPweight_hist.root");
...
//	RooAddPdf comb_bkg("comb_bkg","",RooArgList(comb_bkg1,bu2dstk),RooArgList(combfrac));
	...
	RooRealVar nbkg4("nbkg4","",2000*0.380,-1000,1500);
	RooRealVar nbkg5("nbkg5","",2000*0.630,-1000,1500);
	RooRealVar nbkg6("nbkg6","",2000*0.092,-1000,1500);
	RooRealVar nbkg7("nbkg7","",2000*0.180,-1000,1500);
	RooRealVar nbkg8("nbkg8","",2000*0.070,-1000,1500);

	//// Constrain Dpipi background
	RooFormulaVar bd2dpipiratio("bd2dpipiratio","@0/@1",RooArgList(nbkg4,nsig));
	RooGaussian constrain_bd2dpipiratio("cbd2dpipi","cbd2dpipi",bd2dpipiratio,RooFit::RooConst(0.380),RooFit::RooConst(0.040));
	...
	RooGaussian constrain_lb2dpkratio("clb2dpk","clb2dpk",lb2dpkratio,RooFit::RooConst(0.092),RooFit::RooConst(0.024));
	
	//// Constrain DKK background
	RooFormulaVar bd2dkkratio("bd2dkkratio","@0/@1",RooArgList(nbkg7,nsig));
	RooGaussian constrain_bd2dkkratio("cbd2dkk","cbd2dkk",bd2dkkratio,RooFit::RooConst(0.180),RooFit::RooConst(0.04));
	
	//// Constrain BsDKK background
	RooFormulaVar bs2dkkratio("bs2dkkratio","@0/@1",RooArgList(nbkg8,nsig));
	RooGaussian constrain_bs2dkkratio("cbs2dkk","cbs2dkk",bs2dkkratio,RooFit::RooConst(0.070),RooFit::RooConst(0.030));


	//RooRealVar nbkg4("nbkg4","",2000*0.217,-1000,1500);
	//RooRealVar nbkg5("nbkg5","",2000*0.990,-1000,1500);
	//RooRealVar nbkg6("nbkg6","",2000*0.088,-1000,1500);
	//RooRealVar nbkg7("nbkg7","",2000*0.105,-1000,1500);
	//RooRealVar nbkg8("nbkg8","",2000*0.036,-1000,1500);

	////// Constrain Dpipi background
	//RooFormulaVar bd2dpipiratio("bd2dpipiratio","@0/@1",RooArgList(nbkg4,nsig));
	//RooGaussian constrain_bd2dpipiratio("cbd2dpipi","cbd2dpipi",bd2dpipiratio,RooFit::RooConst(0.217),RooFit::RooConst(0.021));

	////// Constrain Dppi background
	//RooFormulaVar lb2dppiratio("lb2dppiratio","@0/@1",RooArgList(nbkg5,nsig));
	//RooGaussian constrain_lb2dppiratio("clb2dppi","clb2dppi",lb2dppiratio,RooFit::RooConst(0.99),RooFit::RooConst(0.22));
	...
	////// Constrain DKK background
	//RooFormulaVar bd2dkkratio("bd2dkkratio","@0/@1",RooArgList(nbkg7,nsig));
	//RooGaussian constrain_bd2dkkratio("cbd2dkk","cbd2dkk",bd2dkkratio,RooFit::RooConst(0.105),RooFit::RooConst(0.025));
	//
	////// Constrain BsDKK background
	//RooFormulaVar bs2dkkratio("bs2dkkratio","@0/@1",RooArgList(nbkg8,nsig));
...
//	Simpdf->plotOn(fPlot, RooFit::ProjWData(cat,combo), RooFit::Components(RooArgSet(bs2dkk)),              RooFit::LineStyle(kDashed),RooFit::LineColor(kOrange-3));
	...
	can->SaveAs("D2pipifit_fit.C");
	can2->SaveAs("D2pipifit_pull.C");
	...
	TCanvas * temp = new TCanvas("temp","");
	aPlot->Draw(); temp->SaveAs("figs/D2pipifit_1.pdf"); temp->SaveAs("figs/D2pipifit_1.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2pipifit_1_log.pdf"); temp->SetLogy(0);
	bPlot->Draw(); printLHCb("R","Other","LHCb (b)"); temp->SaveAs("figs/D2pipifit_2.pdf"); temp->SaveAs("figs/D2pipifit_2.C");
	temp->SaveAs("figs/fig8b.pdf");
	temp->SaveAs("figs/fig8b.png");
	temp->SaveAs("figs/fig8b.eps");
	temp->SaveAs("figs/fig8b.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2pipifit_2_log.pdf"); temp->SetLogy(0);
	cPlot->Draw(); printLHCb("R","Other","LHCb (c)"); temp->SaveAs("figs/D2pipifit_3.pdf"); temp->SaveAs("figs/D2pipifit_3.C");
	temp->SaveAs("figs/fig8c.pdf");
	temp->SaveAs("figs/fig8c.png");
	temp->SaveAs("figs/fig8c.eps");
	temp->SaveAs("figs/fig8c.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2pipifit_3_log.pdf"); temp->SetLogy(0);
	dPlot->Draw(); printLHCb("R","Other","LHCb (d)"); temp->SaveAs("figs/D2pipifit_4.pdf"); temp->SaveAs("figs/D2pipifit_4.C");
	temp->SaveAs("figs/fig8d.pdf");
	temp->SaveAs("figs/fig8d.png");
	temp->SaveAs("figs/fig8d.eps");
	temp->SaveAs("figs/fig8d.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2pipifit_4_log.pdf"); temp->SetLogy(0);
	ePlot->Draw(); printLHCb("R","Other","LHCb (e)"); temp->SaveAs("figs/D2pipifit_5.pdf"); temp->SaveAs("figs/D2pipifit_5.C");
	temp->SaveAs("figs/fig8e.pdf");
	temp->SaveAs("figs/fig8e.png");
	temp->SaveAs("figs/fig8e.eps");
	temp->SaveAs("figs/fig8e.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2pipifit_5_log.pdf"); temp->SetLogy(0);
	fPlot->Draw(); temp->SaveAs("figs/D2pipifit_1-5.pdf"); temp->SaveAs("figs/D2pipifit_1-5.C");
	temp->SetLogy(1); temp->SaveAs("figs/D2pipifit_1-5_log.pdf"); temp->SetLogy(0);
	aPlot3->Draw(); temp->SaveAs("figs/D2pipifit_1_pull.pdf"); temp->SaveAs("figs/D2pipifit_1_pull.C");
	bPlot3->Draw(); temp->SaveAs("figs/D2pipifit_2_pull.pdf"); temp->SaveAs("figs/D2pipifit_2_pull.C");
	cPlot3->Draw(); temp->SaveAs("figs/D2pipifit_3_pull.pdf"); temp->SaveAs("figs/D2pipifit_3_pull.C");
	dPlot3->Draw(); temp->SaveAs("figs/D2pipifit_4_pull.pdf"); temp->SaveAs("figs/D2pipifit_4_pull.C");
	ePlot3->Draw(); temp->SaveAs("figs/D2pipifit_5_pull.pdf"); temp->SaveAs("figs/D2pipifit_5_pull.C");
	aPlot4->Draw(); printLHCb("R","Other","LHCb (a)"); temp->SaveAs("figs/D2pipifit_1_window.pdf"); temp->SaveAs("figs/D2pipifit_1_window.C");
	temp->SaveAs("figs/fig8a.pdf");
	temp->SaveAs("figs/fig8a.png");
	temp->SaveAs("figs/fig8a.eps");
	temp->SaveAs("figs/fig8a.C");
	bPlot4->Draw(); temp->SaveAs("figs/D2pipifit_2_window.pdf"); temp->SaveAs("figs/D2pipifit_2_window.C");
	cPlot4->Draw(); temp->SaveAs("figs/D2pipifit_3_window.pdf"); temp->SaveAs("figs/D2pipifit_3_window.C");
	dPlot4->Draw(); temp->SaveAs("figs/D2pipifit_4_window.pdf"); temp->SaveAs("figs/D2pipifit_4_window.C");
	ePlot4->Draw(); temp->SaveAs("figs/D2pipifit_5_window.pdf"); temp->SaveAs("figs/D2pipifit_5_window.C");
