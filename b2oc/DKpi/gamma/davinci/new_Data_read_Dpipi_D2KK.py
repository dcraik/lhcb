...
tuple.addBranches ({
    "B"    : " [B0 ->  ( D0 ->  K+  K- )  ( rho(770)0 ->  pi+  pi- ) ]CC ",
    "D"    : " [B0 -> ^( D0 ->  K+  K- )  ( rho(770)0 ->  pi+  pi- ) ]CC ",
    "D0p"  : " [B0 ->  ( D0 -> ^K+  K- )  ( rho(770)0 ->  pi+  pi- ) ]CC ",
    "D0m"  : " [B0 ->  ( D0 ->  K+ ^K- )  ( rho(770)0 ->  pi+  pi- ) ]CC ",      
    "pip"  : " [B0 ->  ( D0 ->  K+  K- )  ( rho(770)0 -> ^pi+  pi- ) ]CC ",       
    "pim"  : " [B0 ->  ( D0 ->  K+  K- )  ( rho(770)0 ->  pi+ ^pi- ) ]CC ",
    "rho"  : " [B0 ->  ( D0 ->  K+  K- ) ^( rho(770)0 ->  pi+  pi- ) ]CC "
})
