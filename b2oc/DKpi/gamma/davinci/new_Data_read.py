...
#tuple.Decay = " [B0 -> ^(D0 -> ^[K-]cc ^[pi+]cc ) [^(K*(892)0 -> ^K+ ^pi-)]CC ]CC"
#tuple.addBranches ({
#    "B"    : " ^[B0 -> (D0 -> [K-]cc [pi+]cc ) [(K*(892)0 -> K+ pi-)]CC ]CC ",
...
tuple.addBranches ({
    "B"    : "  B0 -> ( D0 ->  K-  pi+ ) ( K*(892)0 -> { K+  pi- ,  K-  pi+ }) ",
    "D"    : "  B0 -> (^D0 ->  K-  pi+ ) ( K*(892)0 -> { K+  pi- ,  K-  pi+ }) ",
    "D0K"  : "  B0 -> ( D0 -> ^K-  pi+ ) ( K*(892)0 -> { K+  pi- ,  K-  pi+ }) ",
    "D0pi" : "  B0 -> ( D0 ->  K- ^pi+ ) ( K*(892)0 -> { K+  pi- ,  K-  pi+ }) ",      
    "K"    : "  B0 -> ( D0 ->  K-  pi+ ) ( K*(892)0 -> {^K+  pi- , ^K-  pi+ }) ",       
    "pi"   : "  B0 -> ( D0 ->  K-  pi+ ) ( K*(892)0 -> { K+ ^pi- ,  K- ^pi+ }) ",
    "Kst"  : "  B0 -> ( D0 ->  K-  pi+ ) (^K*(892)0 -> { K+  pi- ,  K-  pi+ }) "
})
