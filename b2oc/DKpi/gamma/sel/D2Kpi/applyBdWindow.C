void applyBdWindow()
{
	...
	TFile* newfileA = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_a.root","recreate");
	TTree* newtreeA = new TTree("DecayTree","DecayTree");

	TFile* newfileB = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_b.root","recreate");
	TTree* newtreeB = new TTree("DecayTree","DecayTree");

	TFile* newfileC = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_c.root","recreate");
	TTree* newtreeC = new TTree("DecayTree","DecayTree");

	TFile* newfileD = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_d.root","recreate");
	TTree* newtreeD = new TTree("DecayTree","DecayTree");

	TFile* newfileE = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_e.root","recreate");
	TTree* newtreeE = new TTree("DecayTree","DecayTree");

	TFile* newfileZ = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_overlapTest.root","recreate");
