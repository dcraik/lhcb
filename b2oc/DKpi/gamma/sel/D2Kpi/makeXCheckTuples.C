void makeXCheckTuples(TString xcheck) {
	TFile* file = TFile::Open("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs.root");
	TTree* tree = (TTree*)file->Get("DecayTree");

	TFile* newfileA = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_a_"+xcheck+".root","recreate");
	TTree* newtreeA = new TTree("DecayTree","DecayTree");

	TFile* newfileB = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_b_"+xcheck+".root","recreate");
	TTree* newtreeB = new TTree("DecayTree","DecayTree");

	TFile* newfileC = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_c_"+xcheck+".root","recreate");
	TTree* newtreeC = new TTree("DecayTree","DecayTree");

	TFile* newfileD = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_d_"+xcheck+".root","recreate");
	TTree* newtreeD = new TTree("DecayTree","DecayTree");

	TFile* newfileE = new TFile("B2D0Kpi_D02Kpi_selBd_Dsignal_Dst25_vetoes_PID3_NND2Kpi_addIMs_Bd25_e_"+xcheck+".root","recreate");
	TTree* newtreeE = new TTree("DecayTree","DecayTree");

	//Double_t mBd(5278.29), sBd(12.56);
	Double_t mBd(5278.27), sBd(12.67);
