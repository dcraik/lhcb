...
TFile * file = TFile::Open("/data/lhcb/phrkbf/B2DKpi/Job2012_B2DKpi_D2Kpi_Scaled/B2D0Kpi_D02piK_selBd_Dsidebands_D50_DK52_PID3_NND2Kpi_addIMs.root");
TTree * DecayTree = dynamic_cast<TTree*>(file->Get("DecayTree"));

RooRealVar D_M("D_M","; m(#pi K) (MeV/c^{2}); Candidates / 0.9 MeV/c^{2}",  1770,1960);
...
RooRealVar nsig("nsig","", 80000.,-1000,120000,"Events");
...
D_Plot->GetXaxis()->SetTitle("m(#pi K) (MeV/c^{2})");
