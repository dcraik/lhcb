void applySelection(TString year, TString mag, TString part="")
{
   ...
   Float_t  Bd_DK_E(0.),  Bd_DK_PX(0.),  Bd_DK_PY(0.),  Bd_DK_PZ(0.);
   Float_t  Bd_Dpi_E(0.),  Bd_Dpi_PX(0.),  Bd_Dpi_PY(0.),  Bd_Dpi_PZ(0.);
                           
   Float_t  Bs_K_E(0.),   Bs_K_PX(0.),   Bs_K_PY(0.),   Bs_K_PZ(0.);
   Float_t  Bs_pi_E(0.),  Bs_pi_PX(0.),  Bs_pi_PY(0.),  Bs_pi_PZ(0.);
   Float_t  Bs_DK_E(0.),  Bs_DK_PX(0.),  Bs_DK_PY(0.),  Bs_DK_PZ(0.);
   Float_t  Bs_Dpi_E(0.),  Bs_Dpi_PX(0.),  Bs_Dpi_PY(0.),  Bs_Dpi_PZ(0.);
   ...
   tree->SetBranchAddress("B_ConstB0Fit_D0_Kplus_PE"         ,   &Bd_DK_E ); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_Kplus_PX"         ,   &Bd_DK_PX); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_Kplus_PY"         ,   &Bd_DK_PY); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_Kplus_PZ"         ,   &Bd_DK_PZ); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PE"        ,   &Bd_Dpi_E ); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PX"        ,   &Bd_Dpi_PX); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PY"        ,   &Bd_Dpi_PY); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PZ"        ,   &Bd_Dpi_PZ); 
   ...
   tree->SetBranchAddress("B_ConstBsFit_D0_Kplus_PE"         ,   &Bs_DK_E ); 
   tree->SetBranchAddress("B_ConstBsFit_D0_Kplus_PX"         ,   &Bs_DK_PX); 
   tree->SetBranchAddress("B_ConstBsFit_D0_Kplus_PY"         ,   &Bs_DK_PY); 
   tree->SetBranchAddress("B_ConstBsFit_D0_Kplus_PZ"         ,   &Bs_DK_PZ); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_PE"        ,   &Bs_Dpi_E ); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_PX"        ,   &Bs_Dpi_PX); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_PY"        ,   &Bs_Dpi_PY); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_PZ"        ,   &Bs_Dpi_PZ); 
   ...
   TString newname("B2D0Kpi_D02Kpi_");
   ...
   TLorentzVector Bd_CM_D0K_4mom;
   TLorentzVector Bd_CM_D0pi_4mom;
   ...
   TLorentzVector Bs_CM_D0K_4mom;
   TLorentzVector Bs_CM_D0pi_4mom;
            ...
            if( B_D0_B_CM_DIRA_OWNPV > 0.99995 && B_D0_B_CM_MINIPCHI2 < 9 && B_ENDVERTEX_CHI2/B_ENDVERTEX_NDOF < 4){// && B_D0_B_CM_ENDVERTEX_CHI2/B_D0_B_CM_ENDVERTEX_NDOF < 4){//B0 
                  ...
                  if(B_Hlt2Topo2BodyBBDTDecision_TOS==1 || B_Hlt2Topo3BodyBBDTDecision_TOS==1 || B_Hlt2Topo4BodyBBDTDecision_TOS==1){//Trigger HLT
                     if(B_L0HadronDecision_TOS==1 || B_L0Global_TIS==1) {//Trigger L0
                           ...
                           //Bd and D0 mass constraints
               	           Bd_CM_D0K_4mom.SetPxPyPzE(    Bd_DK_PX/1000, Bd_DK_PY/1000, Bd_DK_PZ/1000, Bd_DK_E/1000);
               	           Bd_CM_D0pi_4mom.SetPxPyPzE(    Bd_Dpi_PX/1000, Bd_Dpi_PY/1000, Bd_Dpi_PZ/1000, Bd_Dpi_E/1000);
		           ...
		           Bd_CM_D0_4mom = Bd_CM_D0K_4mom + Bd_CM_D0pi_4mom;
                           ...
                           //Bs and D0 mass constraints
               	           Bs_CM_D0K_4mom.SetPxPyPzE(    Bs_DK_PX/1000, Bs_DK_PY/1000, Bs_DK_PZ/1000, Bs_DK_E/1000);
               	           Bs_CM_D0pi_4mom.SetPxPyPzE(    Bs_Dpi_PX/1000, Bs_Dpi_PY/1000, Bs_Dpi_PZ/1000, Bs_Dpi_E/1000);
		           ...
		           Bs_CM_D0_4mom = Bs_CM_D0K_4mom + Bs_CM_D0pi_4mom;
			   ...
			   //Bd specific section
             	           if((Bd_K_PX**2+Bd_K_PY**2+Bd_K_PZ**2)**.5<100000 && (Bd_pi_PX**2+Bd_pi_PY**2+Bd_pi_PZ**2)**.5<100000) {//max p
             	              if((Bd_DK_PX**2+Bd_DK_PY**2+Bd_DK_PZ**2)**.5<100000 && (Bd_Dpi_PX**2+Bd_Dpi_PY**2+Bd_Dpi_PZ**2)**.5<100000) {//max p
                                 newtree->Fill();
			      }
			   }
