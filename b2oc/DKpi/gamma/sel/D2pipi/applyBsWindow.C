void applyBsWindow()
{
	...
	TFile* newfile = new TFile("B2D0Kpi_D02pipi_selBd_Dsignal_Dst25_vetoes_PID3_NND2pipi_addIMs_Bs25.root","recreate");
	TTree* newtree = new TTree("DecayTree","DecayTree");

	TFile* newfileA = new TFile("B2D0Kpi_D02pipi_selBd_Dsignal_Dst25_vetoes_PID3_NND2pipi_addIMs_Bs25_a.root","recreate");
	TTree* newtreeA = new TTree("DecayTree","DecayTree");

	TFile* newfileB = new TFile("B2D0Kpi_D02pipi_selBd_Dsignal_Dst25_vetoes_PID3_NND2pipi_addIMs_Bs25_b.root","recreate");
	TTree* newtreeB = new TTree("DecayTree","DecayTree");

	TFile* newfileC = new TFile("B2D0Kpi_D02pipi_selBd_Dsignal_Dst25_vetoes_PID3_NND2pipi_addIMs_Bs25_c.root","recreate");
	TTree* newtreeC = new TTree("DecayTree","DecayTree");

	TFile* newfileD = new TFile("B2D0Kpi_D02pipi_selBd_Dsignal_Dst25_vetoes_PID3_NND2pipi_addIMs_Bs25_d.root","recreate");
	TTree* newtreeD = new TTree("DecayTree","DecayTree");

	TFile* newfileE = new TFile("B2D0Kpi_D02pipi_selBd_Dsignal_Dst25_vetoes_PID3_NND2pipi_addIMs_Bs25_e.root","recreate");
	TTree* newtreeE = new TTree("DecayTree","DecayTree");

   Double_t mBs(5277.51+87.19), sBs(13.68);
