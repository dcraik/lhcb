{
	...
	TFile* f = TFile::Open("B2D0Kpi_D02pipi_selBd_Dst25_PID3_NND2pipi.root");
	...
	c1.cd(4);
	t->Draw("B_D0_B_CM_M>>h4","NN>-0.1&&NN<0.3&&B_D0_B_CM_M>5150","");
	c1.cd(5);
	t->Draw("B_D0_B_CM_M>>h5","NN>0.3&&NN<0.65&&B_D0_B_CM_M>5150","");
	c1.cd(6);
