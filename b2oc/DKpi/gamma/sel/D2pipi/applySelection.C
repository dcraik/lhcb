...
{
   TString fname("B2D0Kpi_D02pipi_");
   ...
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PE"        ,   &Bd_Dp_E ); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PX"        ,   &Bd_Dp_PX); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PY"        ,   &Bd_Dp_PY); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PZ"        ,   &Bd_Dp_PZ); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_0_PE"      ,   &Bd_Dm_E ); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_0_PX"      ,   &Bd_Dm_PX); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_0_PY"      ,   &Bd_Dm_PY); 
   tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_0_PZ"      ,   &Bd_Dm_PZ); 
   ...
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_PE"        ,   &Bs_Dp_E ); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_PX"        ,   &Bs_Dp_PX); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_PY"        ,   &Bs_Dp_PY); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_PZ"        ,   &Bs_Dp_PZ); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_0_PE"      ,   &Bs_Dm_E ); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_0_PX"      ,   &Bs_Dm_PX); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_0_PY"      ,   &Bs_Dm_PY); 
   tree->SetBranchAddress("B_ConstBsFit_D0_piplus_0_PZ"      ,   &Bs_Dm_PZ); 
   ...
   TString newname("B2D0Kpi_D02pipi_");
