void applySelPart3() {
	...
	TFile* file = TFile::Open("B2D0Kpi_D02pipi_selBd_Dsidebands_vetoes_PID3_NND2pipi_addIMs.root");
	TTree* tree = (TTree*)file->Get("DecayTree");

	tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PE"        ,    Bd_Dd1_E ); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PX"        ,    Bd_Dd1_PX); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PY"        ,    Bd_Dd1_PY); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_PZ"        ,    Bd_Dd1_PZ); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_0_PE"      ,    Bd_Dd2_E ); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_0_PX"      ,    Bd_Dd2_PX); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_0_PY"      ,    Bd_Dd2_PY); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_piplus_0_PZ"      ,    Bd_Dd2_PZ); 
	...
	TFile* newfile = new TFile("B2D0Kpi_D02pipi_selBd_Dsignal_Dst25_vetoes_PID3_NND2pipi_addIMs.root","recreate");
