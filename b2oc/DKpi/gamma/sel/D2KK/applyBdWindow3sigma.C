void applyBdWindow3sigma()
{
	TFile* file = TFile::Open("B2D0Kpi_D02KK_selBd_Dsignal_Dst25_vetoes_PID3_NND2KK_addIMs.root");
	TTree* tree = (TTree*)file->Get("DecayTree");

	TFile* newfileA = new TFile("B2D0Kpi_D02KK_selBd_Dsignal_Dst25_vetoes_PID3_NND2KK_addIMs_Bd25_a_3sigma.root","recreate");
	TTree* newtreeA = new TTree("DecayTree","DecayTree");

	TFile* newfileB = new TFile("B2D0Kpi_D02KK_selBd_Dsignal_Dst25_vetoes_PID3_NND2KK_addIMs_Bd25_b_3sigma.root","recreate");
	TTree* newtreeB = new TTree("DecayTree","DecayTree");

	TFile* newfileC = new TFile("B2D0Kpi_D02KK_selBd_Dsignal_Dst25_vetoes_PID3_NND2KK_addIMs_Bd25_c_3sigma.root","recreate");
	TTree* newtreeC = new TTree("DecayTree","DecayTree");

	TFile* newfileD = new TFile("B2D0Kpi_D02KK_selBd_Dsignal_Dst25_vetoes_PID3_NND2KK_addIMs_Bd25_d_3sigma.root","recreate");
	TTree* newtreeD = new TTree("DecayTree","DecayTree");

	TFile* newfileE = new TFile("B2D0Kpi_D02KK_selBd_Dsignal_Dst25_vetoes_PID3_NND2KK_addIMs_Bd25_e_3sigma.root","recreate");
...
//   Double_t mBd(5278.53), sBd(12.65);
   ...
   for (Int_t i=0; i<nentries;++i) {
      ...
      if(B_D0_B_CM_M > mBd - 3.*sBd && B_D0_B_CM_M < mBd + 3.*sBd) {
