void applySelPart3() {
	...
	TFile* file = TFile::Open("B2D0Kpi_D02KK_selBd_Dsidebands_vetoes_PID3_NND2KK_addIMs.root");
	...
	tree->SetBranchAddress("B_ConstB0Fit_D0_Kplus_0_PE"      ,    Bd_Dd2_E ); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_Kplus_0_PX"      ,    Bd_Dd2_PX); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_Kplus_0_PY"      ,    Bd_Dd2_PY); 
	tree->SetBranchAddress("B_ConstB0Fit_D0_Kplus_0_PZ"      ,    Bd_Dd2_PZ); 
	...
	TFile* newfile = new TFile("B2D0Kpi_D02KK_selBd_Dsignal_Dst25_vetoes_PID3_NND2KK_addIMs.root","recreate");
