...
void fit(){
	...
	RooRealVar DSM(  "DSM",  "DSM",  1888.,  2048.,  "MeV/#it{c}^{2}"); 
	DSM.setBins(30);
	RooRealVar DSLOGIPCHI2(  "DSLOGIPCHI2",  "DSLOGIPCHI2",  -5.,  15.,  ""); 
	DSLOGIPCHI2.setBins(20);
	RooRealVar DSPHIM(  "DSPHIM",  "DSPHIM",  990.,  1050.,  ""); 

	RooRealVar dMass("dMass","mass mean",1968.,1948.,1988.);
	RooRealVar dWidth("dWidth","mass width",20.,5.,50.);
	RooGaussian sigMass("sigMass","",DSM,dMass,dWidth);

	RooRealVar p0("p0","p0",0., -0.1, 0.1);
	RooPolynomial bkgMass("bkgMass","",DSM, RooArgList(p0));
	...
	RooRealVar DE(  "DSE",  "DSE",  0.,   2e6); 
	RooRealVar DPX( "DSPX", "DSPX", -1e5, 1e5); 
	RooRealVar DPY( "DSPY", "DSPY", -1e5, 1e5); 
	RooRealVar DPZ( "DSPZ", "DSPZ", 0.,   2e6); 
	...
	RooDataSet* dsPeak = dynamic_cast<RooDataSet*>(ds.reduce("DSM>1948 && DSM<1988"));
	RooDataSet* dsSB   = dynamic_cast<RooDataSet*>(ds.reduce("DSM<1908 || DSM>2028"));
	...
	p0.setConstant();
        ...
        DSM.setRange("signal",1948.,1988.);
        DSM.setRange("sideLo",1888.,1908.);
        DSM.setRange("sideHi",2028.,2048.);
        DSM.setRange("full",1888.,2048.);

        double fsig_1 = sigMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("signal"))->getVal();
        double fsig_2 = sigMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("sideLo"))->getVal();
        double fsig_3 = sigMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("sideHi"))->getVal();
        double fsig_0 = sigMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("full"))->getVal();

        double fbkg_1 = bkgMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("signal"))->getVal();
        double fbkg_2 = bkgMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("sideLo"))->getVal();
        double fbkg_3 = bkgMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("sideHi"))->getVal();
        double fbkg_0 = bkgMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("full"))->getVal();
	...
	RooPromptShape promptLOGIPCHI2("promptLOGIPCHI2","",DSLOGIPCHI2,promptMean,promptWidth,promptAsym,promptRhoL,promptRhoR);
	//RooGaussian promptLOGIPCHI2("promptLOGIPCHI2","",DSLOGIPCHI2,promptMean,promptWidth);

	RooRealVar displacedMean("displacedMean","mean displ.",5.,3.,12.);
	RooRealVar displacedWidth("displacedWidth","width displ.",3.,1.,8.);
	RooGaussian displacedLOGIPCHI2("displacedLOGIPCHI2","",DSLOGIPCHI2,displacedMean,displacedWidth);

	RooKeysPdf bkgLOGIPCHI2("bkgLOGIPCHI2","",DSLOGIPCHI2,*dsSB);
	...
	plot(DSM, 1888., 2048., ds, data_pdf, sig_pdfs, bkg_pdfs, "DSM_full", "m_{K#pi#pi}");
	plot(DSLOGIPCHI2, -5., 15., *dsPeak, data_pdf2, sig_pdfs2, bkg_pdfs2, "DSIPChi2_full", "log(IP#chi^{2})");
	...
	print("DSparams_full.dat",params);
	...
	RooAddPdf data_pdf2SP( "data_pdf2SP",  "data_pdf2SP", RooArgList(promptLOGIPCHI2,displacedLOGIPCHI2,bkgLOGIPCHI2), RooArgList(promptYieldSP,displacedYieldSP,bkgYieldSP) );
        ...
        TFile * newFile0 = TFile::Open("data0_Ds_sWeights.root","RECREATE");
	...
	RooDataSet* ds4Peak = dynamic_cast<RooDataSet*>(ds4.reduce("DSM>1948 && DSM<1988"));
	...
	p0.setConstant();
        ...
        fsig_1 = sigMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("signal"))->getVal();
        fsig_2 = sigMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("sideLo"))->getVal();
        fsig_3 = sigMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("sideHi"))->getVal();
        fsig_0 = sigMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("full"))->getVal();

        fbkg_1 = bkgMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("signal"))->getVal();
        fbkg_2 = bkgMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("sideLo"))->getVal();
        fbkg_3 = bkgMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("sideHi"))->getVal();
        fbkg_0 = bkgMass.createIntegral(RooArgSet(DSM),RooFit::NormSet(DSM),RooFit::Range("full"))->getVal();
	...
	plot(DSM, 1888., 2048., ds4, data_pdf, sig_pdfs, bkg_pdfs, "DSM_4", "m_{K#pi#pi}");
	plot(DSLOGIPCHI2, -5., 15., *ds4Peak, data_pdf2, sig_pdfs2, bkg_pdfs2, "DSIPChi2_4", "log(IP#chi^{2})");

	print("DSparams_4.dat",params);
	...
	bkgYieldSP.setVal(bkgInPeakYield.getVal());
        ...
        TFile * newFile1 = TFile::Open("data4_Ds_sWeights.root","RECREATE");
	...
	RooDataSet* ds5Peak = dynamic_cast<RooDataSet*>(ds5.reduce("DSM>1948 && DSM<1988"));
	...
	plot(DSM, 1888., 2048., ds5, data_pdf, sig_pdfs, bkg_pdfs, "DSM_5", "m_{K#pi#pi}");
	plot(DSLOGIPCHI2, -5., 15., *ds5Peak, data_pdf2, sig_pdfs2, bkg_pdfs2, "DSIPChi2_5", "log(IP#chi^{2})");

	print("DSparams_5.dat",params);
	...
	bkgYieldSP.setVal(bkgInPeakYield.getVal());
        ...
        TFile * newFile2 = TFile::Open("data5_Ds_sWeights.root","RECREATE");
