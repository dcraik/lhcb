...
// Fri Oct 20 07:13:57 2017 by ROOT version 6.06/00
// from TTree data/data
// found on file: /eos/lhcb/user/d/dcraik/jets/296/1/output.root
//////////////////////////////////////////////////////////
...
Int_t skimZs::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimZs::LoadTree(Long64_t entry)
{
...
void skimZs::Show(Long64_t entry)
{
...
Int_t skimZs::Cut(Long64_t entry)
{
