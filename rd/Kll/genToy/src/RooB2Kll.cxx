...
RooB2Kll::RooB2Kll(const char *name, const char *title, 
  ...
  G005("G005","G005",this,_G005),
  G006("G006","G006",this,_G006),
  a("a","a",this,_a),
  b("b","b",this,_b),
  n("n","n",this,_n)
{ 
 ...
 RooB2Kll::RooB2Kll(const RooB2Kll& other, const char* name) :  
   ...
   G005("G005",this,other.G005),
   G006("G006",this,other.G006),
   a("a",this,other.a),
   b("b",this,other.b),
   n("n",this,other.n)
 { 
...
//    rate += G005*(63. *pow(cosTheta,5) - 70. *pow(cosTheta,3) + 15. *cosTheta)/8.;
//    rate += G006*(231.*pow(cosTheta,6) - 315.*pow(cosTheta,4) + 105.*pow(cosTheta,2) - 5.)/16.;
    Double_t eff = 1. + a*cosTheta*cosTheta + b*cosTheta*cosTheta*cosTheta*cosTheta;
    Double_t norm = n*2.*G000;//-2.*_g2/15. + 5./3.; // need additional term in normalisation if G003, G004 != 0
