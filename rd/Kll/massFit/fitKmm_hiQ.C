{
	...
	RooDataSet * data1 = dynamic_cast<RooDataSet*>(data->reduce("Psi_M> 3870 && Psi_M< 4690"));
...
//  11  ratio        1.60407e+00   9.46569e-03   3.93086e-03  -7.72555e-01
	...
	can->SaveAs("plots/Kmm_hiQ.pdf");

	can->SetLogy();
        B_M_RF_Plot->SetMinimum(1.e-1);
        B_M_RF_Plot->SetMaximum(5.e+2);
	B_M_RF_Plot->Draw();
	can->SaveAs("plots/Kmm_hiQ_log.pdf");
      ...
      sData->GetSDataSet()->write("~/Kll/tuples/Kmm_hiQ_sWeights.txt");
