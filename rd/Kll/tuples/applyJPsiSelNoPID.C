void applyJPsiSelNoPID(TString file) {
	TString fname   = "/Disk/ecdf-nfs-ppe/lhcb/dcraik/Kee/"; fname+=file; fname+=".root";
	TString outname = "/Disk/ecdf-nfs-ppe/lhcb/dcraik/Kee/"; outname+=file; outname+="_presel_JPsi_noPID.root";
	...
	for(Int_t i=0; i<nEntries; ++i) {
		...
		//JPsi
		if((J_psi_1S_M*J_psi_1S_M)<6000000 || (J_psi_1S_M*J_psi_1S_M)>10080000) continue;
